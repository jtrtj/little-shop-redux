RSpec.describe 'User' do
  context 'visiting /invoices/dashboard' do
    ...
    it 'should see highest and lowest total invoice prices' do
      ...
      expect(page).to have_content("Highest Invoice Total: #{Invoice.invoice_with_lowest_total.id}")
      expect(page).to have_content("Lowest Invoice Total: #{Invoice.invoice_with_highest_total.id}")
    end
  end
end
